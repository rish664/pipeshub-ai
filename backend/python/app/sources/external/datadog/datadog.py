...
class DatadogDataSource:
    ...
    def __init__(self, client_or_config: Union[Configuration, object]) -> None:  # type: ignore[reportUnknownParameterType]
        super().__init__()
        if hasattr(client_or_config, "get_sdk"):  # type: ignore[reportUnknownArgumentType]
            self._config: Configuration = getattr(client_or_config, "get_sdk")()  # type: ignore[reportUnknownMemberType]
        else:
    ...
    def list_dashboards(self) -> DatadogResponse:
        ...
        try:
            with ApiClient(self._config) as api_client:  # type: ignore[reportUnknownMemberType]
                api = DashboardsApi(api_client)  # type: ignore[reportUnknownMemberType]
                result: Any = api.list_dashboards()  # type: ignore[reportUnknownMemberType]
                return DatadogResponse(success=True, data=self._to_dict_safe(result))  # type: ignore[reportUnknownArgumentType]
    ...
    def get_dashboard(self, dashboard_id: str) -> DatadogResponse:
        ...
        try:
            with ApiClient(self._config) as api_client:  # type: ignore[reportUnknownMemberType]
                api = DashboardsApi(api_client)  # type: ignore[reportUnknownMemberType]
                result: Any = api.get_dashboard(dashboard_id=dashboard_id)  # type: ignore[reportUnknownMemberType]
                return DatadogResponse(success=True, data=self._to_dict_safe(result))  # type: ignore[reportUnknownArgumentType]
        except Exception as e:
            return DatadogResponse(success=False, error=str(e))
    def create_dashboard(self, body: Dict[str, Any]) -> DatadogResponse:
        ...
        try:
            with ApiClient(self._config) as api_client:  # type: ignore[reportUnknownMemberType]
                api = DashboardsApi(api_client)  # type: ignore[reportUnknownMemberType]
                dashboard = Dashboard(**body)  # type: ignore[reportUnknownMemberType]
                result: Any = api.create_dashboard(body=dashboard)  # type: ignore[reportUnknownMemberType]
                return DatadogResponse(success=True, data=self._to_dict_safe(result))  # type: ignore[reportUnknownArgumentType]
        except Exception as e:
            return DatadogResponse(success=False, error=str(e))
    def list_monitors(self, group_states: Optional[str] = None, name: Optional[str] = None, tags: Optional[str] = None, monitor_tags: Optional[str] = None, page: Optional[int] = None, page_size: Optional[int] = None) -> DatadogResponse:
        ...
        try:
            with ApiClient(self._config) as api_client:  # type: ignore[reportUnknownMemberType]
                api = MonitorsApi(api_client)  # type: ignore[reportUnknownMemberType]
                ...
                result: Any = api.list_monitors(**kwargs)  # type: ignore[reportUnknownMemberType]
                return DatadogResponse(success=True, data=self._to_dict_safe(result))  # type: ignore[reportUnknownArgumentType]
        except Exception as e:
            return DatadogResponse(success=False, error=str(e))
    def get_monitor(self, monitor_id: int) -> DatadogResponse:
        ...
        try:
            with ApiClient(self._config) as api_client:  # type: ignore[reportUnknownMemberType]
                api = MonitorsApi(api_client)  # type: ignore[reportUnknownMemberType]
                result: Any = api.get_monitor(monitor_id=monitor_id)  # type: ignore[reportUnknownMemberType]
                return DatadogResponse(success=True, data=self._to_dict_safe(result))  # type: ignore[reportUnknownArgumentType]
        except Exception as e:
            return DatadogResponse(success=False, error=str(e))
    def create_monitor(self, body: Dict[str, Any]) -> DatadogResponse:
        ...
        try:
            with ApiClient(self._config) as api_client:  # type: ignore[reportUnknownMemberType]
                api = MonitorsApi(api_client)  # type: ignore[reportUnknownMemberType]
                monitor = Monitor(**body)  # type: ignore[reportUnknownMemberType]
                result: Any = api.create_monitor(body=monitor)  # type: ignore[reportUnknownMemberType]
                return DatadogResponse(success=True, data=self._to_dict_safe(result))  # type: ignore[reportUnknownArgumentType]
        except Exception as e:
            return DatadogResponse(success=False, error=str(e))
    def update_monitor(self, monitor_id: int, body: Dict[str, Any]) -> DatadogResponse:
        ...
        try:
            with ApiClient(self._config) as api_client:  # type: ignore[reportUnknownMemberType]
                api = MonitorsApi(api_client)  # type: ignore[reportUnknownMemberType]
                update_req = MonitorUpdateRequest(**body)  # type: ignore[reportUnknownMemberType]
                result: Any = api.update_monitor(monitor_id=monitor_id, body=update_req)  # type: ignore[reportUnknownMemberType]
                return DatadogResponse(success=True, data=self._to_dict_safe(result))  # type: ignore[reportUnknownArgumentType]
        except Exception as e:
            return DatadogResponse(success=False, error=str(e))
    def delete_monitor(self, monitor_id: int) -> DatadogResponse:
        ...
        try:
            with ApiClient(self._config) as api_client:  # type: ignore[reportUnknownMemberType]
                api = MonitorsApi(api_client)  # type: ignore[reportUnknownMemberType]
                result: Any = api.delete_monitor(monitor_id=monitor_id)  # type: ignore[reportUnknownMemberType]
                return DatadogResponse(success=True, data=self._to_dict_safe(result))  # type: ignore[reportUnknownArgumentType]
        except Exception as e:
            return DatadogResponse(success=False, error=str(e))
    def list_users(self, page_size: Optional[int] = None, page_number: Optional[int] = None, sort: Optional[str] = None, sort_dir: Optional[str] = None, filter_str: Optional[str] = None, filter_status: Optional[str] = None) -> DatadogResponse:
        ...
        try:
            with ApiClient(self._config) as api_client:  # type: ignore[reportUnknownMemberType]
                api = UsersApi(api_client)  # type: ignore[reportUnknownMemberType]
                kwargs: Dict[str, Any] = {}
                ...
                result: Any = api.list_users(**kwargs)  # type: ignore[reportUnknownMemberType]
                return DatadogResponse(success=True, data=self._to_dict_safe(result))  # type: ignore[reportUnknownArgumentType]
        except Exception as e:
            return DatadogResponse(success=False, error=str(e))
    def get_user(self, user_id: str) -> DatadogResponse:
        ...
        try:
            with ApiClient(self._config) as api_client:  # type: ignore[reportUnknownMemberType]
                api = UsersApi(api_client)  # type: ignore[reportUnknownMemberType]
                result: Any = api.get_user(user_id=user_id)  # type: ignore[reportUnknownMemberType]
                return DatadogResponse(success=True, data=self._to_dict_safe(result))  # type: ignore[reportUnknownArgumentType]
        except Exception as e:
            return DatadogResponse(success=False, error=str(e))
    def list_hosts(self, filter_str: Optional[str] = None, sort_field: Optional[str] = None, sort_dir: Optional[str] = None, start: Optional[int] = None, count: Optional[int] = None, from_ts: Optional[int] = None) -> DatadogResponse:
        ...
        try:
            with ApiClient(self._config) as api_client:  # type: ignore[reportUnknownMemberType]
                api = HostsApi(api_client)  # type: ignore[reportUnknownMemberType]
                kwargs: Dict[str, Any] = {}
                if filter_str is not None:
                    kwargs['filter'] = filter_str
                ...
                result: Any = api.list_hosts(**kwargs)  # type: ignore[reportUnknownMemberType]
                return DatadogResponse(success=True, data=self._to_dict_safe(result))  # type: ignore[reportUnknownArgumentType]
        except Exception as e:
            return DatadogResponse(success=False, error=str(e))
    def query_timeseries(self, from_ts: int, to_ts: int, query: str) -> DatadogResponse:
        ...
        try:
            with ApiClient(self._config) as api_client:  # type: ignore[reportUnknownMemberType]
                api = MetricsApiV1(api_client)  # type: ignore[reportUnknownMemberType]
                result: Any = api.query_metrics(_from=from_ts, to=to_ts, query=query)  # type: ignore[reportUnknownMemberType]
                return DatadogResponse(success=True, data=self._to_dict_safe(result))  # type: ignore[reportUnknownArgumentType]
        except Exception as e:
            return DatadogResponse(success=False, error=str(e))
    def list_active_metrics(self, filter_configured: Optional[bool] = None, filter_tags_configured: Optional[str] = None, filter_metric_type: Optional[str] = None, filter_include_percentiles: Optional[bool] = None, filter_queried: Optional[bool] = None, filter_tags: Optional[str] = None, window_seconds: Optional[int] = None, page_size: Optional[int] = None, page_cursor: Optional[str] = None) -> DatadogResponse:
        ...
        try:
            with ApiClient(self._config) as api_client:  # type: ignore[reportUnknownMemberType]
                api = MetricsApiV2(api_client)  # type: ignore[reportUnknownMemberType]
                kwargs = self._params(
                ...
                result: Any = api.list_tag_configurations(**kwargs)  # type: ignore[reportUnknownMemberType]
                return DatadogResponse(success=True, data=self._to_dict_safe(result))  # type: ignore[reportUnknownArgumentType]
        except Exception as e:
            return DatadogResponse(success=False, error=str(e))
    def list_incidents(self, page_size: Optional[int] = None, page_offset: Optional[int] = None) -> DatadogResponse:
        ...
        try:
            with ApiClient(self._config) as api_client:  # type: ignore[reportUnknownMemberType]
                api = IncidentsApi(api_client)  # type: ignore[reportUnknownMemberType]
                kwargs = self._params(page_size=page_size, page_offset=page_offset)
                result: Any = api.list_incidents(**kwargs)  # type: ignore[reportUnknownMemberType]
                return DatadogResponse(success=True, data=self._to_dict_safe(result))  # type: ignore[reportUnknownArgumentType]
        except Exception as e:
            return DatadogResponse(success=False, error=str(e))
    def get_incident(self, incident_id: str) -> DatadogResponse:
        ...
        try:
            with ApiClient(self._config) as api_client:  # type: ignore[reportUnknownMemberType]
                api = IncidentsApi(api_client)  # type: ignore[reportUnknownMemberType]
                result: Any = api.get_incident(incident_id=incident_id)  # type: ignore[reportUnknownMemberType]
                return DatadogResponse(success=True, data=self._to_dict_safe(result))  # type: ignore[reportUnknownArgumentType]
        except Exception as e:
            return DatadogResponse(success=False, error=str(e))
    def search_logs(self, filter_query: Optional[str] = None, filter_from: Optional[str] = None, filter_to: Optional[str] = None, sort: Optional[str] = None, page_cursor: Optional[str] = None, page_limit: Optional[int] = None) -> DatadogResponse:
        ...
        try:
            with ApiClient(self._config) as api_client:  # type: ignore[reportUnknownMemberType]
                api = LogsApi(api_client)  # type: ignore[reportUnknownMemberType]
                filter_obj = LogsQueryFilter()  # type: ignore[reportUnknownMemberType]
                if filter_query is not None:
                    filter_obj.query = filter_query  # type: ignore[reportUnknownMemberType]
                if filter_from is not None:
                    filter_obj._from = filter_from  # type: ignore[reportUnknownMemberType]
                if filter_to is not None:
                    filter_obj.to = filter_to  # type: ignore[reportUnknownMemberType]
                body_kwargs: Dict[str, Any] = {'filter': filter_obj}
                if sort is not None:
                    body_kwargs['sort'] = LogsSort(sort)  # type: ignore[reportUnknownMemberType]
                if page_cursor is not None or page_limit is not None:
                    page_obj = LogsListRequestPage()  # type: ignore[reportUnknownMemberType]
                    if page_cursor is not None:
                        page_obj.cursor = page_cursor  # type: ignore[reportUnknownMemberType]
                    if page_limit is not None:
                        page_obj.limit = page_limit  # type: ignore[reportUnknownMemberType]
                    body_kwargs['page'] = page_obj
                request_body = LogsListRequest(**body_kwargs)  # type: ignore[reportUnknownMemberType]
                result: Any = api.list_logs(body=request_body)  # type: ignore[reportUnknownMemberType]
                return DatadogResponse(success=True, data=self._to_dict_safe(result))  # type: ignore[reportUnknownArgumentType]
        except Exception as e:
            return DatadogResponse(success=False, error=str(e))
    def list_synthetics_tests(self, page_size: Optional[int] = None, page_number: Optional[int] = None) -> DatadogResponse:
        ...
        try:
            with ApiClient(self._config) as api_client:  # type: ignore[reportUnknownMemberType]
                api = SyntheticsApi(api_client)  # type: ignore[reportUnknownMemberType]
                kwargs = self._params(page_size=page_size, page_number=page_number)
                result: Any = api.list_tests(**kwargs)  # type: ignore[reportUnknownMemberType]
                return DatadogResponse(success=True, data=self._to_dict_safe(result))  # type: ignore[reportUnknownArgumentType]
        except Exception as e:
            return DatadogResponse(success=False, error=str(e))
    def get_synthetics_test(self, public_id: str) -> DatadogResponse:
        ...
        try:
            with ApiClient(self._config) as api_client:  # type: ignore[reportUnknownMemberType]
                api = SyntheticsApi(api_client)  # type: ignore[reportUnknownMemberType]
                result: Any = api.get_test(public_id=public_id)  # type: ignore[reportUnknownMemberType]
                return DatadogResponse(success=True, data=self._to_dict_safe(result))  # type: ignore[reportUnknownArgumentType]
        except Exception as e:
            return DatadogResponse(success=False, error=str(e))
    def list_downtimes(self, current_only: Optional[bool] = None, with_creator: Optional[bool] = None) -> DatadogResponse:
        ...
        try:
            with ApiClient(self._config) as api_client:  # type: ignore[reportUnknownMemberType]
                api = DowntimesApi(api_client)  # type: ignore[reportUnknownMemberType]
                kwargs = self._params(current_only=current_only, with_creator=with_creator)
                result: Any = api.list_downtimes(**kwargs)  # type: ignore[reportUnknownMemberType]
                return DatadogResponse(success=True, data=self._to_dict_safe(result))  # type: ignore[reportUnknownArgumentType]
        except Exception as e:
            return DatadogResponse(success=False, error=str(e))
    def list_service_definitions(self, page_size: Optional[int] = None, page_number: Optional[int] = None, schema_version: Optional[str] = None) -> DatadogResponse:
        ...
        try:
            with ApiClient(self._config) as api_client:  # type: ignore[reportUnknownMemberType]
                api = ServiceDefinitionApi(api_client)  # type: ignore[reportUnknownMemberType]
                kwargs = self._params(page_size=page_size, page_number=page_number, schema_version=schema_version)
                result: Any = api.list_service_definitions(**kwargs)  # type: ignore[reportUnknownMemberType]
                return DatadogResponse(success=True, data=self._to_dict_safe(result))  # type: ignore[reportUnknownArgumentType]
        except Exception as e:
            return DatadogResponse(success=False, error=str(e))
