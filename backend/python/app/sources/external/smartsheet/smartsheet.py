...
class SmartsheetDataSource:
    ...
    def get_current_user(self) -> SmartsheetResponse:
        ...
        result: Any = self._sdk.Users.get_current_user()  # type: ignore[reportUnknownMemberType]
        return SmartsheetResponse(success=True, data=result)  # type: ignore[reportUnknownArgumentType]
    def list_users(self, *, include_all: bool = True) -> SmartsheetResponse:
        """List all users in the organization.  [users]"""
        result: Any = self._sdk.Users.list_users(include_all=include_all)  # type: ignore[reportUnknownMemberType]
        return SmartsheetResponse(success=True, data=result)  # type: ignore[reportUnknownArgumentType]
    def list_sheets(self, *, page_size: int = 100, page: int = 1, include_all: bool = False, modified_since: Union[str, None] = None) -> SmartsheetResponse:
        ...
        result: Any = self._sdk.Sheets.list_sheets(**params)  # type: ignore[reportUnknownMemberType]
        return SmartsheetResponse(success=True, data=result)  # type: ignore[reportUnknownArgumentType]
    def get_sheet(self, sheet_id: int, *, page_size: int = 100, page: int = 1) -> SmartsheetResponse:
        """Get a specific sheet by ID.  [sheets]"""
        result: Any = self._sdk.Sheets.get_sheet(sheet_id, page_size=page_size, page=page)  # type: ignore[reportUnknownMemberType]
        return SmartsheetResponse(success=True, data=result)  # type: ignore[reportUnknownArgumentType]
    def create_sheet(self, sheet_obj: object) -> SmartsheetResponse:
        ...
        result: Any = self._sdk.Home.create_sheet(sheet_obj)  # type: ignore[reportUnknownMemberType]
        return SmartsheetResponse(success=True, data=result)  # type: ignore[reportUnknownArgumentType]
    def create_sheet_in_folder(self, folder_id: int, sheet_obj: object) -> SmartsheetResponse:
        ...
        result: Any = self._sdk.Folders.create_sheet_in_folder(folder_id, sheet_obj)  # type: ignore[reportUnknownMemberType]
        return SmartsheetResponse(success=True, data=result)  # type: ignore[reportUnknownArgumentType]
    def create_sheet_in_workspace(self, workspace_id: int, sheet_obj: object) -> SmartsheetResponse:
        ...
        result: Any = self._sdk.Workspaces.create_sheet_in_workspace(workspace_id, sheet_obj)  # type: ignore[reportUnknownMemberType]
        return SmartsheetResponse(success=True, data=result)  # type: ignore[reportUnknownArgumentType]
    def update_sheet(self, sheet_id: int, sheet_obj: object) -> SmartsheetResponse:
        ...
        result: Any = self._sdk.Sheets.update_sheet(sheet_id, sheet_obj)  # type: ignore[reportUnknownMemberType]
        return SmartsheetResponse(success=True, data=result)  # type: ignore[reportUnknownArgumentType]
    def delete_sheet(self, sheet_id: int) -> SmartsheetResponse:
        """Delete a sheet by ID.  [sheets]"""
        result: Any = self._sdk.Sheets.delete_sheet(sheet_id)  # type: ignore[reportUnknownMemberType]
        return SmartsheetResponse(success=True, data=result)  # type: ignore[reportUnknownArgumentType]
    def add_rows(self, sheet_id: int, row_objects: list[object]) -> SmartsheetResponse:
        ...
        result: Any = self._sdk.Sheets.add_rows(sheet_id, row_objects)  # type: ignore[reportUnknownMemberType]
        return SmartsheetResponse(success=True, data=result)  # type: ignore[reportUnknownArgumentType]
    def update_rows(self, sheet_id: int, row_objects: list[object]) -> SmartsheetResponse:
        ...
        result: Any = self._sdk.Sheets.update_rows(sheet_id, row_objects)  # type: ignore[reportUnknownMemberType]
        return SmartsheetResponse(success=True, data=result)  # type: ignore[reportUnknownArgumentType]
    def delete_rows(self, sheet_id: int, row_ids: list[int]) -> SmartsheetResponse:
        """Delete rows from a sheet by row IDs.  [rows]"""
        result: Any = self._sdk.Sheets.delete_rows(sheet_id, row_ids)  # type: ignore[reportUnknownMemberType]
        return SmartsheetResponse(success=True, data=result)  # type: ignore[reportUnknownArgumentType]
    def list_columns(self, sheet_id: int, *, include_all: bool = True) -> SmartsheetResponse:
        """List all columns in a sheet.  [columns]"""
        result: Any = self._sdk.Sheets.get_columns(sheet_id, include_all=include_all)  # type: ignore[reportUnknownMemberType]
        return SmartsheetResponse(success=True, data=result)  # type: ignore[reportUnknownArgumentType]
    def get_column(self, sheet_id: int, column_id: int) -> SmartsheetResponse:
        """Get a specific column in a sheet.  [columns]"""
        result: Any = self._sdk.Sheets.get_column(sheet_id, column_id)  # type: ignore[reportUnknownMemberType]
        return SmartsheetResponse(success=True, data=result)  # type: ignore[reportUnknownArgumentType]
    def add_columns(self, sheet_id: int, column_objects: list[object]) -> SmartsheetResponse:
        ...
        result: Any = self._sdk.Sheets.add_columns(sheet_id, column_objects)  # type: ignore[reportUnknownMemberType]
        return SmartsheetResponse(success=True, data=result)  # type: ignore[reportUnknownArgumentType]
    def update_column(self, sheet_id: int, column_id: int, column_obj: object) -> SmartsheetResponse:
        ...
        result: Any = self._sdk.Sheets.update_column(sheet_id, column_id, column_obj)  # type: ignore[reportUnknownMemberType]
        return SmartsheetResponse(success=True, data=result)  # type: ignore[reportUnknownArgumentType]
    def list_workspaces(self) -> SmartsheetResponse:
        """List all workspaces.  [workspaces]"""
        result: Any = self._sdk.Workspaces.list_workspaces()  # type: ignore[reportUnknownMemberType]
        return SmartsheetResponse(success=True, data=result)  # type: ignore[reportUnknownArgumentType]
    def get_workspace(self, workspace_id: int) -> SmartsheetResponse:
        """Get a specific workspace by ID.  [workspaces]"""
        result: Any = self._sdk.Workspaces.get_workspace(workspace_id)  # type: ignore[reportUnknownMemberType]
        return SmartsheetResponse(success=True, data=result)  # type: ignore[reportUnknownArgumentType]
    def list_folders(self, *, include_all: bool = True) -> SmartsheetResponse:
        """List all top-level folders in the user's Home.  [folders]"""
        result: Any = self._sdk.Home.list_folders(include_all=include_all)  # type: ignore[reportUnknownMemberType]
        return SmartsheetResponse(success=True, data=result)  # type: ignore[reportUnknownArgumentType]
    def get_folder(self, folder_id: int) -> SmartsheetResponse:
        """Get a specific folder by ID.  [folders]"""
        result: Any = self._sdk.Folders.get_folder(folder_id)  # type: ignore[reportUnknownMemberType]
        return SmartsheetResponse(success=True, data=result)  # type: ignore[reportUnknownArgumentType]
    def list_workspace_folders(self, workspace_id: int) -> SmartsheetResponse:
        """List all folders in a workspace.  [folders]"""
        result: Any = self._sdk.Workspaces.list_folders(workspace_id)  # type: ignore[reportUnknownMemberType]
        return SmartsheetResponse(success=True, data=result)  # type: ignore[reportUnknownArgumentType]
    def list_reports(self, *, page_size: int = 100, page: int = 1, modified_since: Union[str, None] = None) -> SmartsheetResponse:
        ...
        result: Any = self._sdk.Reports.list_reports(**params)  # type: ignore[reportUnknownMemberType]
        return SmartsheetResponse(success=True, data=result)  # type: ignore[reportUnknownArgumentType]
    def get_report(self, report_id: int, *, page_size: int = 100, page: int = 1) -> SmartsheetResponse:
        """Get a specific report by ID.  [reports]"""
        result: Any = self._sdk.Reports.get_report(report_id, page_size=page_size, page=page)  # type: ignore[reportUnknownMemberType]
        return SmartsheetResponse(success=True, data=result)  # type: ignore[reportUnknownArgumentType]
    def search(self, query: str) -> SmartsheetResponse:
        """Search for sheets, reports, rows, etc.  [search]"""
        result: Any = self._sdk.Search.search(query)  # type: ignore[reportUnknownMemberType]
        return SmartsheetResponse(success=True, data=result)  # type: ignore[reportUnknownArgumentType]
    def search_sheet(self, sheet_id: int, query: str) -> SmartsheetResponse:
        """Search within a specific sheet.  [search]"""
        result: Any = self._sdk.Search.search_sheet(sheet_id, query)  # type: ignore[reportUnknownMemberType]
        return SmartsheetResponse(success=True, data=result)  # type: ignore[reportUnknownArgumentType]
    def get_home(self) -> SmartsheetResponse:
        """Get the user's Home (top-level sheets, folders, workspaces, etc.).  [home]"""
        result: Any = self._sdk.Home.list_all_contents()  # type: ignore[reportUnknownMemberType]
        return SmartsheetResponse(success=True, data=result)  # type: ignore[reportUnknownArgumentType]
    def list_sheet_discussions(self, sheet_id: int, *, include_all: bool = True) -> SmartsheetResponse:
        ...
        result: Any = self._sdk.Discussions.get_all_discussions(sheet_id, include_all=include_all)  # type: ignore[reportUnknownMemberType]
        return SmartsheetResponse(success=True, data=result)  # type: ignore[reportUnknownArgumentType]
    def list_sheet_attachments(self, sheet_id: int, *, include_all: bool = True) -> SmartsheetResponse:
        ...
        result: Any = self._sdk.Attachments.list_all_attachments(sheet_id, include_all=include_all)  # type: ignore[reportUnknownMemberType]
        return SmartsheetResponse(success=True, data=result)  # type: ignore[reportUnknownArgumentType]
