"""Comprehensive tests for app.connectors.sources.microsoft.common.msgraph_client.

Covers all public methods, dataclasses, helper functions, pagination,
error handling, and the search_query region-retry logic.
"""
